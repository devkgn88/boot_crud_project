...
<img src="https://capsule-render.vercel.app/api?type=soft&color=auto&height=150&section=header&text=안녕하세요,%20김가남입니다.&fontSize=50" /> <br>
...
## 프로젝트
### WALK(강아지 산책 코스 공유 프로젝트)
* 산책 코스를 구상하고, 공유할 수 있는 커뮤니티
* 핵심 기술 :
* 주요 기능 : 

### 회의고(사내 회의실 관리 서비스)
* 회의실 예약, 리뷰 작성, 실시간 현황 확인 가능 그룹웹어
* 핵심 기술 :
* 주요 기능 :
